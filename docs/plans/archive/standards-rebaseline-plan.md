...
docs builds; see "What is open" on the [status board](plan-board.md) for detail.
...
Two consequences, which the standing rules in the [status board](plan-board.md) now
carry:
